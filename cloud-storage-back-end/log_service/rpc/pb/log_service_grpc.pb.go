...
func (c *auditServiceRpcClient) CreateOperationLog(ctx context.Context, in *OperationLogReq, opts ...grpc.CallOption) (*OperationLogResp, error) {
	...
	err := c.cc.Invoke(ctx, AuditServiceRpc_CreateOperationLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAuditServiceRpcServer must be embedded to have forward compatible implementations.
...
func (c *sshServiceRpcClient) SaveSshInfo(ctx context.Context, in *SshInfoReq, opts ...grpc.CallOption) (*SshInfoResp, error) {
	out := new(SshInfoResp)
	err := c.cc.Invoke(ctx, SshServiceRpc_SaveSshInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sshServiceRpcClient) DeleteSshInfo(ctx context.Context, in *DeleteSshInfoReq, opts ...grpc.CallOption) (*SshInfoResp, error) {
	out := new(SshInfoResp)
	err := c.cc.Invoke(ctx, SshServiceRpc_DeleteSshInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sshServiceRpcClient) GetSshInfo(ctx context.Context, in *GetSshInfosReq, opts ...grpc.CallOption) (*SshInfoListResp, error) {
	...
	err := c.cc.Invoke(ctx, SshServiceRpc_GetSshInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSshServiceRpcServer must be embedded to have forward compatible implementations.
