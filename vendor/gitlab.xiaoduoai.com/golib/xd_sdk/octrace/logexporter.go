...
// LoggerOptions provides options for LogExporter
...
func NewLogExporter(options LoggerOptions) (*LogExporter, error) {
	e := &LogExporter{reader: metricexport.NewReader(), o: options}
	var err error
